...
Public Class dlgBackupManager
    ...
    If Translations.MsgBoxTranslate("Are you sure you want to open this data file?" & Environment.NewLine & "This will replace the current data.", MessageBoxButtons.YesNo, "Back up Manager") = MsgBoxResult.No Then
            Return
        End If
    ...
    If Translations.MsgBoxTranslate("Are you sure you want to delete this file?" & Environment.NewLine & "You cannot undo this action and all its data will be lost.", MessageBoxButtons.YesNo, "Back up Manager") = MsgBoxResult.No Then
            Return
        End If
