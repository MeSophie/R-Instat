...
Public Class sdgPlots
    ...
    Public Sub InitialiseControls()
        ...
        ucrChkColour.SetText("Include Colour")
        ucrChkColour.AddParameterPresentCondition(True, "colour", True)
        ...
        ucrChkColour.AddToLinkedControls(ucrInputAxisType, {True}, bNewLinkedHideIfParameterMissing:=True)
        ucrChkColour.AddToLinkedControls(ucrPnlScale, {True}, bNewLinkedHideIfParameterMissing:=True)
        ucrChkColour.AddToLinkedControls(ucrPnlColourPalette, {True}, bNewLinkedHideIfParameterMissing:=True)
            ...
            Select Case ucrInputAxisType.GetText
                Case "discrete"
                    ...
                    If rdoDiverging.Checked OrElse rdoVertical.Checked OrElse rdoSequential.Checked Then
                        If rdoColour.Checked AndAlso Not ucrInputPalettes.IsEmpty Then
                        ...
                        End If
                        If rdoFill.Checked AndAlso Not ucrInputPalettes.IsEmpty Then
                ...
                Case "continuous"
                    ...
                    If rdoDiverging.Checked OrElse rdoQualitative.Checked OrElse rdoSequential.Checked Then
                        If rdoColour.Checked AndAlso Not ucrInputPaletteContinuous.IsEmpty Then
                        ...
                        Else
                            clsBaseOperator.RemoveParameterByName("scale_color_distiller")
                        End If
                        If rdoFill.Checked AndAlso Not ucrInputPaletteContinuous.IsEmpty Then
    ...
    Private Sub ucrPnlColourPalette_ControlValueChanged(ucrChangedControl As ucrCore) Handles ucrPnlColourPalette.ControlValueChanged, ucrPnlScale.ControlValueChanged
        HideShowCanvaFill()
        HideShowCanvacolor()
        SetComboBoxItems()
        ...
        If ucrChkColour.Checked Then
            Select Case ucrInputAxisType.GetText
                Case "discrete"
                    ...
                    ElseIf rdoColour.Checked AndAlso rdoViridis.Checked Then
                    ...
                    ElseIf rdoColour.Checked AndAlso rdoGgthemes.Checked Then
                        clsBaseOperator.RemoveParameterByName("scale_fill")
                        clsBaseOperator.RemoveParameterByName("scale_colour")
                        clsBaseOperator.RemoveParameterByName("scale_fill_brewer")
                        clsBaseOperator.RemoveParameterByName("scale_color_brewer")
                        ...
                        ElseIf ucrInputColorFunctions.GetText = "scale_color_colorblind" Then
                            ...
                            clsBaseOperator.RemoveParameterByName("scale_color_gdocs")
                            clsBaseOperator.RemoveParameterByName("scale_color_ptol")
                        ElseIf ucrInputColorFunctions.GetText = "scale_color_canva" AndAlso Not ucrInputCanvasColorPalette.IsEmpty Then
                    ...
                    ElseIf rdoFill.Checked AndAlso (rdoSequential.Checked OrElse rdoDiverging.Checked OrElse rdoQualitative.Checked) Then
                        ...
                        clsBaseOperator.RemoveParameterByName("scale_fill_hc")
                        clsBaseOperator.RemoveParameterByName("scale_fill_pander")
                        clsBaseOperator.RemoveParameterByName("scale_fillr_colorblind")
                        clsBaseOperator.RemoveParameterByName("scale_fill_calc")
                        clsBaseOperator.RemoveParameterByName("scale_fill_canva")
                        clsBaseOperator.RemoveParameterByName("scale_fill_economist")
                        clsBaseOperator.RemoveParameterByName("scale_fill_excel")
                        ...
                        grpScalecolorhc.Hide()
                        ucrInputPalettes.Show()
                    ElseIf rdoFill.Checked AndAlso rdoViridis.Checked Then
                        ...
                        grpScalecolorhc.Hide()
                        ucrInputPalettes.Hide()
                    ElseIf rdoFill.Checked AndAlso rdoGgthemes.Checked Then
                        clsBaseOperator.RemoveParameterByName("scale_color_solarized")
                        clsBaseOperator.RemoveParameterByName("scale_color_stata")
                        clsBaseOperator.RemoveParameterByName("scale_color_hc")
                        clsBaseOperator.RemoveParameterByName("scale_color_pander")
                        ...
                        ElseIf ucrInputFillFunction.GetText = "scale_fill_colorblind" Then
                            ...
                            clsBaseOperator.RemoveParameterByName("scale_fill_gdocs")
                            clsBaseOperator.RemoveParameterByName("scale_fill_ptol")
                        ElseIf ucrInputFillFunction.GetText = "scale_fill_canva" AndAlso Not ucrInputCanvasFillPalette.IsEmpty Then
    ...
    Private Sub ucrInputColorFunctions_ControlValueChanged(ucrChangedControl As ucrCore) Handles ucrInputColorFunctions.ControlValueChanged, ucrInputCanvasColorPalette.ControlValueChanged
        GroupeColorScale()
        HideShowCanvacolor()
    End Sub
    ...
    Private Sub ucrInputPalettes_ControlValueChanged(ucrChangedControl As ucrCore) Handles ucrInputPalettes.ControlValueChanged
        AddRemovePaletteDiscrete()
    End Sub
    ...
    Private Sub HideShowCanvaFill()
        If ucrInputAxisType.GetText = "discrete" Then
            If rdoFill.Checked AndAlso rdoGgthemes.Checked Then
                If ucrInputFillFunction.GetText = "scale_fill_canva" Then
                    ucrInputCanvasFillPalette.Visible = True
                Else
    ...
    Private Sub HideShowCanvacolor()
        If ucrInputAxisType.GetText = "discrete" Then
            If rdoColour.Checked AndAlso rdoGgthemes.Checked Then
                If ucrInputColorFunctions.GetText = "scale_color_canva" Then
                    ucrInputCanvasColorPalette.Visible = True
                Else
