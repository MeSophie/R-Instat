...
Public Class dlgSurvey
    ...
    Private clsDCastLeftContextFormula, clsVar2Operator, clsWeightsOperator, clsIdOperator, clsFpcOperator, clsStrataOperator, clsXOperator, clsVar1operator As New ROperator
